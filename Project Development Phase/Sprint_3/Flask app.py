...
# Import dataset 
df = pd.read_csv('C:/Users/ELCOT/Desktop/coding/Processed_data.csv')
...
app = Flask(__name__,template_folder='C:/Users/ELCOT/Desktop/templates')
model = pickle.load(open('C:/Users/ELCOT/Desktop/coding/flight.pkl', 'rb'))

@app.route('/')
def home():
    return render_template('C:/Users/ELCOT/Desktop/Project/templates/index.html')
...
def predict():
    ...
    return render_template('C:/Users/ELCOT/Desktop/Project/templates/index.html', prediction_text=output)
